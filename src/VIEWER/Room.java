...
public class Room extends javax.swing.JFrame {
    ...
    public Room() {
        initComponents();
         ...
         b.DisplayTable(ROOMS, "SELECT room_id, room_number, room_type, pax FROM tbl_rooms");
    }
    ...
    private void initComponents() {
        ...
        ROOMS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "room_id", "room_number", "room_type", "pax", "is_available"
            }
        ));
        ...
        jPanel11.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 430, 510, 50));
...
pax.setSelectedIndex(0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        b.Chony("insert into tbl_rooms (room_id, room_number, room_type, pax, is_available) " +
        "values (null, '"+room_number1+"', '"+room_type1+"', '"+pax1+"', now())");
        b.DisplayTable(ROOMS, "SELECT room_id, room_number, room_type, pax FROM tbl_rooms");
